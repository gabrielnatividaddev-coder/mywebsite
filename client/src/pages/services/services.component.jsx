    ...
    <div className='home' >
        ...
        <div className='outerservicesdiv'> 
         ...
         <a class="card-container" href ={"https://github.com/ricaricabile/boxing-news-website"}><img height="200" src={ReactWebsiteHeader1} ></img>
            ...
            </a>   <a class="card-container" href ={"https://github.com/ricaricabile/boxing-news-website"}><img height="200" src={ReactWebsiteHeader2} ></img>
                <p class="reduce">
            ...
            </a>   <a class="card-container" href ={"https://github.com/ricaricabile/boxing-news-website"}><img height="200" src={ReactWebsiteSidebar1} ></img>
                <p class="reduce">
            ...
            </a>   <a class="card-container" href ={"https://github.com/ricaricabile/boxing-news-website"}><img height="200" src={ReactWebsiteSidebar2} ></img>
                <p class="reduce">
